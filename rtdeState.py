...
class RtdeState:
    ...
    def initialize(self):
        ...
        print(self.con.get_controller_version())
...
if __name__ == "__main__":
    ...
    while state_monitor.keep_running:
        ...
        dev_current = f'{state.joint_position_deviation_ratio:.2f}'

        if dev_current != dev_old:
            print(f'Ratio: {dev_current}')
            dev_old = dev_current
